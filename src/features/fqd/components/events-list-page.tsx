        ...
        {events.length === 0 && filtering ? (
          ...
          <>
            {/*
              ...
              sm+: 2-column grid so cards sit side-by-side like ProjectPanel does.
              Each card is full-width within its column — no fixed px width.
            */}
