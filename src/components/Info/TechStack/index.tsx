...
export default function TeckStack({ className }: Props) {
  return (
...
export function TranslateWrapper({ children, reverse }: TranslateWrapperProps) {
  return (
    <motion.div
...
function LogoItem({ name, imgSrc }: LogoItemProps) {
  return (
    <a
      // href="/"
      rel="nofollow"
