...
function ParalaxScrollText({ text, style, className, scrollYProgress }: Props, ref: React.ForwardedRef<HTMLDivElement>) {
...
export default forwardRef<HTMLDivElement, Props>(ParalaxScrollText);
