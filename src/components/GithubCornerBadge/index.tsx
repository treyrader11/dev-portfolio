...
export default function GithubCornerBadge({ className }: Props) {
  return (
    <div className={cn("fixed", "left-0", "top-0 z-[99]", "rotate-[270deg]")}>
      <Link
        href="https://github.com/treyrader11/dev-portfolio"
        title="Fork me on GitHub"
        className={cn("group", "relative", "z-[50]", className)}
        target="_blank"
        rel="noreferrer"
      >
        <svg
        ...
        >
          ...
          <path
            ...
            className="octo-arm group-hover:animate-octocat-wave"
          />
          <path
