...
const phrase = userData?.hero?.phrase;

// const targetedWords = phrase
//   .split(" ")
//   .filter((word) => word.includes("Senior") || word.includes("developer"));
...
const targetedWords = phrase
  ...
  .filter(
    (word) =>
      ...
      word.toLowerCase().includes("native")
  );
...
// below the highlighted text works with new data
...
//           <div>
//             {phrase.split(" ").map((word, i) => {
//               // Compare lowercase version of the word
//               const isTargetedWord = targetedWords.includes(word);
