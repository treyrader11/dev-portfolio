        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="md:ml-4">
            ...
            <div className="inline-flex flex-col my-20 icons-container">
              ...
              <div
                className={cn(
                  "flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4"
                )}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex flex-row space-x-8 social-icons">
              <a
                ...
                className={cn(
                  "h-10 w-10 rounded-full hover:bg-blue-500 flex items-center justify-center cursor-pointer"
                )}
              >
                <svg
                  width="24"
